...
| Feature | controller és use case együtt, kontrollált függőségekkel | **IMPLEMENTED** availability és admin auth controller/use-case esetekre; teljes front-controller dispatch nincs automatizálva | **PLANNED:** booking write, pricing és iCal admin műveletek |
