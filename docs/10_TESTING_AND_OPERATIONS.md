...
|---|---|---|---|
| Unit | tiszta domain szabályok: fél-nyitott intervallum, napállapot, validáció | **IMPLEMENTED:** availability, booking create/hash/overlap, minimális pricing, auth/2FA, booking e-mail és branding | **PLANNED:** teljes státuszállapotgép, összetett pricing és iCal |
...
| Feature | controller és use case együtt, kontrollált függőségekkel | **IMPLEMENTED:** availability, admin auth és booking create HTTP-szerződés mockolt workflow-val; teljes front-controller dispatch nincs automatizálva | **PLANNED:** teljes PDO-val összerakott booking API E2E, pricing/admin és iCal műveletek |
...
**IMPLEMENTED alap:** `person_night` szabálykiválasztás, éjszakaszám, HUF minor-unit számítás, hiányzó/azonos prioritású szabály hibája és leválasztott snapshot tesztelt. **PLANNED:** gyermekársáv, szezon/hétvége, fix díj, IFA, kedvezmény és admin override csak elfogadott szabály után.
