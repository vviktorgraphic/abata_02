    ...
    public function fetchBookingDetail(AdminBookingDetailQuery $query): ?array
    {
        ...
        $statement = $this->pdo->prepare(
            'SELECT b.id, b.reference, b.status, b.guest_name AS contact_name,
                    ...
                    b.privacy_accepted_at, b.privacy_policy_version, b.privacy_policy_url,
        ...
        return [
            ...
            'privacy_accepted_at' => $row['privacy_accepted_at'] !== null ? (string) $row['privacy_accepted_at'] : null,
            'privacy_policy_version' => $row['privacy_policy_version'] !== null ? (string) $row['privacy_policy_version'] : null,
            'privacy_policy_url' => $row['privacy_policy_url'] !== null ? (string) $row['privacy_policy_url'] : null,
